...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contact.contact_name'
        db.delete_column(u'iuvo_app_contact', 'contact_name')

        # Adding field 'Contact.name'
        db.add_column(u'iuvo_app_contact', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Contact.contact_name'
        db.add_column(u'iuvo_app_contact', 'contact_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Deleting field 'Contact.name'
        db.delete_column(u'iuvo_app_contact', 'name')
    ...
    models = {
        ...
        u'iuvo_app.contact': {
            ...
            'phone_int': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
