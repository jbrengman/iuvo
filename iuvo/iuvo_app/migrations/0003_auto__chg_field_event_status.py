...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'iuvo_app_event', 'status', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Event.status'
        db.alter_column(u'iuvo_app_event', 'status', self.gf('django.db.models.fields.IntegerField')(default=''))
